...
let sliderSlider = new Swiper('.slider', {
	...
	slidesPerView: 4, //можно указать 1.5
...
let sliderSliderFloors = new Swiper('.slider-floors', {
	...
	//Стрелки-----------------------------------------------------------------------------------------
	navigation: {
		nextEl: '.arrow__item_next-floors',
		prevEl: '.arrow__item_prev-floors',
	},

	//Буллеты-----------------------------------------------------------------------------------------
	pagination: {
		el: '.swiper-pagination-floors',
...
new Swiper('.slider-developments', {
	...
	//Стрелки-----------------------------------------------------------------------------------------
	navigation: {
		nextEl: '.arrow__item_next-developments',
		prevEl: '.arrow__item_prev-developments',
	},
